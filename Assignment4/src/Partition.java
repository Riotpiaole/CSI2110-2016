...
public class Partition <T> {
	...
	public void union (Node p, Node q) {
		 ...
		 Node iterator = smaller.first;
		 while(iterator.next != null){
			 iterator.cluster=larger;
			 iterator=iterator.next;
		 }
		 iterator.cluster=larger;

		 Node endIterator=larger.first;
		 while(endIterator.next !=null){
			 	endIterator=endIterator.next;
		 }
		 endIterator.next =smaller.first;
